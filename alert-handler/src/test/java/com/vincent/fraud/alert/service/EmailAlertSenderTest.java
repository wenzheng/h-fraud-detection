...
class EmailAlertSenderTest {
    ...
    @Test
    void shouldReportEmailChannelAndAcceptSend() {
        EmailAlertSender sender = new EmailAlertSender();

        assertThat(sender.channel()).isEqualTo(AlertRoutingProperties.Channel.EMAIL);
